"""
Django settings for indoorair_front project.
...
SECRET_KEY = 'd3&o1_(ga1!o78@_j#ellrjqavcyksnn#3!m$b#(130*+e5c&%'
...
ROOT_URLCONF = 'indoorair_front.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # very important
                'indoorair_front.context_processor.extra_address_context_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'indoorair_front.wsgi.application'
